...
- [ ] Describe Middleware?
    functions that are executed on specified api calls that can execute code, verify users, check for missing data etc.
- [ ] Describe a Resource?
    Is what is passed on a post/put call usually along with an ID, modifying the specified ID if any.
- [ ] What can the API return to help clients know if a request was successful?
    res.status(201) + a custom message
